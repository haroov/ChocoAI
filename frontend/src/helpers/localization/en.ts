...
export const en = {
  ...
  FlowEditor: {
    ...
    serverValidationEnforcedEvenIfEmpty: 'enforced even if pattern is empty',
    recommendedPattern: 'Recommended pattern:',
    recommendedMinMax: 'min {min}, max {max}',
    applyRecommended: 'Apply recommended',
    validationEmail: 'Email',
    validationIsraeliMobile: 'Israeli mobile (normalizes +972/spaces/hyphens)',
    validationIsraeliId: 'Israeli ID (checksum)',
    validationIlBusinessId: 'IL business ID (Company/VAT, checksum)',
